...
const getOrgProject = (projectName, logger, octokit, context) => __awaiter(void 0, void 0, void 0, function* () {
    var _c;
    return (0, misc_1.isActive)('ORG') && 'organization' in context.payload ? (_c = (yield octokit.paginate(octokit.rest.projects.listForOrg, { org: context.repo.owner, state: 'open' })).find(item => item.name === projectName)) === null || _c === void 0 ? void 0 : _c.id : undefined;
});
...
const getUserProject = (projectName, logger, octokit, context) => __awaiter(void 0, void 0, void 0, function* () {
    var _d;
    return (0, misc_1.isActive)('USER') && !('organization' in context.payload) ? (_d = (yield octokit.paginate(octokit.rest.projects.listForUser, { username: context.repo.owner, state: 'open' })).find(item => item.name === projectName)) === null || _d === void 0 ? void 0 : _d.id : undefined;
});
