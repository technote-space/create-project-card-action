...
exports.getColumnIds = (projectIds, columnName, logger, octokit) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    for (const projectId of projectIds) {
        const columnId = (_a = (yield octokit.paginate(octokit.projects.listColumns.endpoint.merge({ 'project_id': projectId }))).find(item => item.name === columnName)) === null || _a === void 0 ? void 0 : _a.id;
